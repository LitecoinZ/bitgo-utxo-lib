...
TransactionBuilder.prototype.setVersionGroupId = function (versionGroupId) {
  if (!((coins.isZcash(this.network) || coins.isLitecoinZ(this.network)) && this.tx.isOverwinterCompatible())) {
...
TransactionBuilder.prototype.setJoinSplits = function (transaction) {
  if (!((coins.isZcash(this.network) || coins.isLitecoinZ(this.network)) && this.tx.supportsJoinSplits())) {
...
TransactionBuilder.fromTransaction = function (transaction, network) {
  ...
  if (coins.isZcash(txbNetwork) || coins.isLitecoinZ(txbNetwork)) {
...
TransactionBuilder.prototype.sign = function (vin, keyPair, redeemScript, hashType, witnessValue, witnessScript) {
  ...
  } else if (coins.isLitecoinZ(this.network)) {
    signatureHash = this.tx.hashForZcashSignature(vin, input.signScript, witnessValue, hashType)
    debug('Calculated LTZ sighash (%s)', signatureHash.toString('hex'))
  } else {
    if (input.witness) {
